//-----------------------------------------------------------------------
// <copyright file="SqlQuery.TryGet.TObject.cs" company="genuine">
...
namespace Vodca
{
    ...
    /// <code source="..\Vodca.Core\Vodca.SqlQuery\SqlQuery.TryGet.TObject.cs" title="SqlQuery.TryGet.TObject.cs" lang="C#" />
    /// </example>
    public static partial class SqlQuery
    {
        ...
        /// <code source="..\Vodca.Core\Vodca.SqlQuery\SqlQuery.TryGet.TObject.cs" title="SqlQuery.TryGet.TObject.cs" lang="C#" />
        /// </example>
        public static TObject TryGetItemByKey<TObject>(string sqlprocedure, params SqlParameter[] primarykey) where TObject : class
        {
            return TryGetItemByKey<TObject>(SqlQueryConnection.DefaultConnectionString, CommandType.StoredProcedure, sqlprocedure, primarykey);
        }
        ...
        public static TObject TryGetItemByKey<TObject>(CommandType commandtype, string sql, params SqlParameter[] primarykey) where TObject : class
        {
            return TryGetItemByKey<TObject>(SqlQueryConnection.DefaultConnectionString, commandtype, sql, primarykey);
        }
        ...
        /// var item = SqlQuery.TryGetItemByKey<![CDATA[<Product>]]>(connectionstring, CommandType.Text, Sql, new SqlParameter("@ProductID", 1));
        /// 
        /// // Do something
        /// </code>
        /// <code source="..\Vodca.Core\Vodca.SqlQuery\SqlQuery.TryGet.TObject.cs" title="SqlQuery.TryGet.TObject.cs" lang="C#" />
        ...
        public static TObject TryGetItemByKey<TObject>(string connectionstring, CommandType commandtype, string sql, params SqlParameter[] primarykey) where TObject : class
        {
            try
            {
                return ItemByKey<TObject>(connectionstring, commandtype, sql, primarykey);
            }
