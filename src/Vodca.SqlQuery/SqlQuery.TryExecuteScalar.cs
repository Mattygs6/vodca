//-----------------------------------------------------------------------------
// <copyright file="SqlQuery.TryExecuteScalar.cs" company="genuine">
...
namespace Vodca
{
    ...
    /// <example>
    /// View code: <br/>
    /// <code source="..\Vodca.Core\Vodca.SqlQuery\SqlQuery.TryExecuteScalar.cs" title="SqlQuery.TryExecuteScalar.cs" lang="C#" />
    /// </example> 
    public static partial class SqlQuery
    {
        ...
        /// int counter = SqlQuery.TryExecuteScalar<![CDATA[<int>]]>("Sql-StoredProcedure-Name");
        ...
        ///     int counter = SqlQuery.TryExecuteScalar<![CDATA[<int>]]>("Sql-StoredProcedure-Name", new SqlParameter("@IsApproved", true)");
        ...
        /// Guid? userid = SqlQuery.TryExecuteScalar<![CDATA[<Guid?>]]>(CommandType.Text, "SELECT UserId FROM dbo.aspnet_Membership WHERE Email = @Email", new SqlParameter("@Email", "Baltika@gmail.com"));
        /// if (userid.HasValue)
        /// {
        ///     // Found a user do something
        /// }
        /// </code>
        /// <code source="..\Vodca.Core\Vodca.SqlQuery\SqlQuery.TryExecuteScalar.cs" title="C# Source File" lang="C#" />
        /// </example>
        ...
        public static TObject TryExecuteScalar<TObject>(string sqlprocedure, params SqlParameter[] parameters)
        {
            return TryExecuteScalar<TObject>(SqlQueryConnection.DefaultConnectionString, CommandType.StoredProcedure, sqlprocedure, parameters);
        }
        ...
        /// Without SqlParameters:
        /// For Sql statements as calculation use value type variables like int, long, double and etc.
        /// int counter = SqlQuery.TryExecuteScalar<![CDATA[<int>]]>(CommandType.Text, "SELECT COUNT (UserId) FROM dbo.aspnet_Membership")");
        /// For Sql statements to retrieve values (get value from column) use Nullable value types like int?, double? and ect. if Sql column can be Nullable.
        /// <br />
        /// ----------------------------------------------------------------------------------------------------------------------------------------------------
        /// With SqlParameters:
        /// For Sql statements as calculation use value type variables like int, long, double and etc.
        ///     int counter = SqlQuery.TryExecuteScalar<![CDATA[<int>]]>(CommandType.Text, "SELECT COUNT (UserId) FROM dbo.aspnet_Membership WHERE IsApproved = @IsApproved", new SqlParameter("@IsApproved", true)");
        /// For Sql statements to retrieve values (get value from column) use Nullable types.
        /// Like example it could be a user with particular email also it couldn't.
        /// Guid? userid = SqlQuery.TryExecuteScalar<![CDATA[<Guid?>]]>(CommandType.Text, "SELECT UserId FROM dbo.aspnet_Membership WHERE Email = @Email", new SqlParameter("@Email", "Baltika@gmail.com"));
        /// if (userid.HasValue)
        ...
        [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1630:DocumentationTextMustContainWhitespace", Justification = "Reviewed. Suppression is OK here.")]
        public static TObject TryExecuteScalar<TObject>(CommandType commandtype, string sql, params SqlParameter[] parameters)
        {
            return TryExecuteScalar<TObject>(SqlQueryConnection.DefaultConnectionString, commandtype, sql, parameters);
        }
        ...
        /// Without SqlParameters:
        /// For Sql statements as calculation use value type variables like int, long, double and etc.
        /// int counter = SqlQuery.TryExecuteScalar<![CDATA[<int>]]>(connectionstring, CommandType.Text, "SELECT COUNT (UserId) FROM dbo.aspnet_Membership")");
        /// For Sql statements to retrieve values (get value from column) use Nullable value types like int?, double? and ect. if Sql column can be Nullable.
        /// <br/>
        /// ----------------------------------------------------------------------------------------------------------------------------------------------------
        /// With SqlParameters:
        /// For Sql statements as calculation use value type variables like int, long, double and etc.
        /// int counter = SqlQuery.TryExecuteScalar<![CDATA[<int>]]>(connectionstring, CommandType.Text, "SELECT COUNT (UserId) FROM dbo.aspnet_Membership WHERE IsApproved = @IsApproved", new SqlParameter("@IsApproved", true)");
        /// For Sql statements to retrieve values (get value from column) use Nullable types.
        /// Like example it could be a user with particular email also it couldn't.
        /// Guid? userid = SqlQuery.TryExecuteScalar<![CDATA[<Guid?>]]>(connectionstring, CommandType.Text, "SELECT UserId FROM dbo.aspnet_Membership WHERE Email = @Email", new SqlParameter("@Email", "Baltika@gmail.com"));
        /// if (userid.HasValue)
        /// {
        /// // Found a user do something
        /// }
        ...
        /// </example>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2100:Review SQL queries for security vulnerabilities", Justification = "User must use Sql Stored procedure or sql parameterized command")]
        public static TObject TryExecuteScalar<TObject>(string connectionstring, CommandType commandtype, string sql, params SqlParameter[] parameters)
        {
            try
            {
                return ExecuteScalar<TObject>(connectionstring, commandtype, sql, parameters);
            }
