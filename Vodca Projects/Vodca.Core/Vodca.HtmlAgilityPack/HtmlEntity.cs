//-----------------------------------------------------------------------------
// <copyright file="HtmlEntity.cs" company="genuine">
...
namespace Vodca.HtmlAgilityPack
{
    ...
    public partial class HtmlEntity
    {
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="HtmlEntity"/> class from being created.
        /// </summary>
        private HtmlEntity()
        {
        }
        ...
        /// <summary>
        /// Gets a collection of entities indexed by name.
        /// </summary>
        public static IDictionary<int, string> EntityName { get; private set; }

        /// <summary>
        /// Gets the entity value.
        /// </summary>
        public static IDictionary<string, int> EntityValue { get; private set; }
                            ...
                            case ';':
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (!EntityValue.ContainsKey(entityname))
                                        {
                                            // nope
                                            sb.Append("&" + entity + ";");
                                        }
                                        ...
                                        {
                                            // we found one
                                            var code = EntityValue[entityname];
                                            sb.Append(Convert.ToChar(code));
                                        }
                                    }
        ...
        /// The collection.
        /// </param>
        private static void Entitize(IEnumerable<HtmlAttribute> collection)
        {
            foreach (HtmlAttribute at in collection)
            {
                at.Value = Entitize(at.Value, useNames: true, entitizeQuotAmpAndLtGt: false);
            }
        }
        ...
        /// The collection.
        /// </param>
        private static void Entitize(IEnumerable<HtmlNode> collection)
        {
