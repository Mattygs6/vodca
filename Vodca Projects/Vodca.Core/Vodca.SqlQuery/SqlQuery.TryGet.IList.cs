//-----------------------------------------------------------------------
// <copyright file="SqlQuery.TryGet.IList.cs" company="genuine">
...
namespace Vodca
{
    ...
    /// <code source="..\Vodca.Core\Vodca.SqlQuery\SqlQuery.TryGet.IList.cs" title="SqlQuery.TryGet.IList.cs" lang="C#" />
    /// </example>
    public static partial class SqlQuery
    {
        ...
        ///             DataEntityProductList item = (Product)e.Item.DataItem;
        ...
        /// var collection = SqlQuery.TryGetIList<![CDATA[<Product>]]>("Sql-StoredProcedure-Name");
        /// // Do some binding with Controls having DataSource
        /// Repeater control = new Repeater();
        /// control.ItemDataBound += new RepeaterItemEventHandler(DemoRepeaterControl_ItemDataBound);
        /// control.DataSource = collection;
        ...
        /// <code source="..\Vodca.Core\Vodca.SqlQuery\SqlQuery.TryGet.IList.cs" title="SqlQuery.TryGet.IList.cs" lang="C#" />
        /// </example>
        public static List<TObject> TryGetIList<TObject>(string sqlprocedure, params SqlParameter[] parameters) where TObject : class
        {
            return TryGetIList<TObject>(SqlQueryConnection.DefaultConnectionString, CommandType.StoredProcedure, sqlprocedure, parameters);
        }
        ...
        ///                     ";
        ///     // Retrieve all collection
        ///     var collection = SqlQuery.TryGetIList<![CDATA[<Product>]]>(CommandType.Text, Sql);
        ///     // Do some binding with Controls having DataSource
        ///     Repeater control = new Repeater();
        ///     control.ItemDataBound += new RepeaterItemEventHandler(DemoRepeaterControl_ItemDataBound);
        ///     control.DataSource = collection;
        ...
        public static List<TObject> TryGetIList<TObject>(CommandType commandtype, string sql, params SqlParameter[] parameters) where TObject : class
        {
            return TryGetIList<TObject>(SqlQueryConnection.DefaultConnectionString, commandtype, sql, parameters);
        }
        ...
        /// ";
        /// // Retrieve all collection
        /// var collection = SqlQuery.TryGetIList<![CDATA[<Product>]]>(connectionstring, CommandType.Text, Sql);
        /// // Do some binding with Controls having DataSource
        /// Repeater control = new Repeater();
        /// control.ItemDataBound += new RepeaterItemEventHandler(DemoRepeaterControl_ItemDataBound);
        /// control.DataSource = collection;
        ...
        /// </example>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2100:Review SQL queries for security vulnerabilities", Justification = "User must use Sql Stored procedure or sql parameterized command")]
        public static List<TObject> TryGetIList<TObject>(string connectionstring, CommandType commandtype, string sql, params SqlParameter[] parameters) where TObject : class
        {
            try
            {
                return IList<TObject>(connectionstring, commandtype, sql, parameters);
            }
