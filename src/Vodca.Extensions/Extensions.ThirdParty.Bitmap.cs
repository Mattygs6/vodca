//-----------------------------------------------------------------------------
// <copyright file="Extensions.ThirdParty.Bitmap.cs" company="genuine">
...
namespace Vodca
{
    ...
    public static partial class Extensions
    {
        ...
        /// }
        /// </code></example>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope", Justification = "Must be dispose in the users code.")]
        public static Bitmap ScaleToSize(this Bitmap bitmap, int width, int height)
        {
            Ensure.IsNotNull(bitmap, "bitmap");
